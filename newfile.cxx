...
int main()
{
    ...
    employees.push_back(new Employee("John Marrt", 30, 8.0));
    employees.push_back(new Manager("Frank Smith", 0, 0, 43000.0));
...
void intro(){
    ...
    cout << "\n\n\n\n\t     MADE BY: HASSAN TAOFIKAT";
    cout << "\n\n\n\n\t     MATRIC NO: H/CTE/22/0697";
